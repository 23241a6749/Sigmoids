...
import { MessageSquare, CreditCard, Activity, ShoppingBag } from 'lucide-react';
                    ...
                    <div className="relative z-10 flex justify-between items-center">
                        <div>
                            <h3 className="font-bold text-2xl flex items-center gap-2">
                                <MessageSquare className="h-6 w-6" /> WhatsApp Live Feed
                            </h3>
                            <p className="text-green-100 text-sm mt-1 opacity-90">Real-time Customer Intelligence</p>
                        </div>
                    </div>
                </div>
